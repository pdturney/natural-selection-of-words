...
# step7-summarize.pl
#
# - summarize the results of running Weka on the testing files
#
# Peter Turney
# October 1, 2018
#
...
while (scalar(@file_names) > 0) {
  ...
  my $probality_file_name = "../perl-output/step6-$train-$test-weka.txt";
  #
  # output file
  #
  my $summary_file_name = "../perl-output/step7-$train-$test-summary.txt";
  #
